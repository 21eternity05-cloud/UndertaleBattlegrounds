...
local RagdollService = require(combatSystemsFolder:WaitForChild("RagdollService")).new(Config, StateService, MovementService)
...
StateService.RagdollService = RagdollService
